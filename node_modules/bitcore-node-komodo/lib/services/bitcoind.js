...
Bitcoin.DEFAULT_CONFIG_SETTINGS = {
  ...
  rpcuser: 'user1132035676',
  rpcpassword: 'pass4c4a0a25f84ffd6a9248fdb37a0d5a16060279d37e5c06dc7ebaa094aaace9279d',
  uacomment: 'bitcore'
};
...
Bitcoin.prototype._loadSpawnConfiguration = function(node) {
  ...
  var configPath = path.resolve(spawnOptions.datadir, './ZILLA.conf');
...
Bitcoin.prototype.syncPercentage = function(callback) {
  ...
  this.client.getBlockchainInfo(function(err, response) {
    ...
    // var percentSynced = response.result.verificationprogress * 100;
    var percentSynced = response.result.blocks / response.result.headers * 100;

    self.headers = response.result.headers;
