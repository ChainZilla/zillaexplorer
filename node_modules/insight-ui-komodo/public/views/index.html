  ...
  <div class="container">
    <div id="home" class="row">
      ...
      <div class="col-xs-12 col-md-4 col-gray">
        ...
        <a class="twitter-timeline" href="https://twitter.com/Chainzillaio" data-tweet-limit="5">Tweets by ChainZilla.IO</a>
        <div id="powered" class="row">
          <div class="powered-text">
            <small class="text-muted" translate>Powered by</small>
          </div>
          <a href="https://www.chainzilla.io/" target="_blank" class="supernet" title="SuperNET"></a>
        </div>
      </div> <!-- END OF COL-3 -->
    </div>
  </div>
