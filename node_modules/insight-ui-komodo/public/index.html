...
<head>
  <base href="/" />
	...
	<title data-ng-if="currency.testnet" data-ng-bind="$root.title + $root.titleDetail + ' | Testnet Insight'">ChainZilla Explorer</title>
	<title data-ng-if="!currency.testnet" data-ng-bind="$root.title + $root.titleDetail + ' | Insight'">ChainZilla Explorer</title>
	<meta name="keywords" content="komodo, transactions, blocks, address, block chain, best block, mining difficulty, hash serialized">
	<meta data-ng-if="currency.testnet" name="description" content="ChainZilla Insight. View detailed information on all ZILLA transactions and blocks.">
	<meta data-ng-if="!currency.testnet" name="description" content="ChainZilla Insight. View detailed information on all ZILLA transactions and blocks.">
